...
<html lang="pt">
    ...
    <body style="margin-left: auto; margin-right: auto;">
                    ...
                    <div class="span8">
                        ...
                        <div id="homeBoxs">
                            ...
                            <br/>
                              <ul class="tops">
                                <li>
                                  <div><img height="95" width="100" alt="ex" src="img/ex.jpeg"/></div>
                                </li>
                                <li>
                                  <div><img height="95" width="100" alt="ex" src="img/ex.jpeg"/></div>
                                </li>
                        ...
                        <div id="homeBoxs">
                            ...
                            <div class="fb-like-box" data-href="https://www.facebook.com/radiohorizonweb" data-width="775" data-height="260" data-show-faces="true" data-stream="false" data-show-border="false" data-header="false"></div><br/>
                        </div>
                    </div>
                    <div class="span3">
                        <div id="boxsLateral">
                            <div class="text"><h4>\\ TOCANDO AGORA //</h4><i class="icon-boxTitulo2 visible-desktop"></i></div>
                            <ul class="nav nav-tabs nav-stacked" style="border-radius:0px;">
                        ...
                        <div id="boxsLateral">
                            <div class="text"><h4>\\ PEDIR MÚSICAS //</h4><i class="icon-boxTitulo2 visible-desktop"></i></div>
                            <br/>
                            <br/>
                        </div>
                        <div id="boxsLateral">
        ...
        <div class="footer" id="footer">
            <div class="container">
                <center> <p class="muted credit">Rádio Horizon &COPY; 2013 - Todos os Direitos Reservados - Desenvolvido por <a href="http://millerdev.com.br" target="_blank">iMillerp</a></p></center>
            </div>
        </div>
        <!-- Le javascript
        ================================================== -->
