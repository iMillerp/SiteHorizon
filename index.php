...
$dadosRadio = simplexml_load_file("http://stream.maisouvida.com/api/ODc4MCsw");
                    ...
                    <div class="span3">
                        <div id="boxsLateral">
                            ...
                            <div style="margin: 5px;">
                                ...
                                Tocando Agora:
                                    <iframe style="margin-bottom: -5px;" name="playerMusicaAtual" src="mm.php" width="150" height="20" frameborder="0" scrolling="no"></iframe></marquee>
                                <br/>
